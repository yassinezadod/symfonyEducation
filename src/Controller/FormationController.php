...
class FormationController extends AbstractController
{
    ...
    /**
     * @Route("/relations", name="app_relations")
     */
    public function relations(FormationRepository $formationRepository): Response
    {
        $formations = $formationRepository->findAllWithEcole();
